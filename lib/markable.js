...
(function (global, factory) {
  ...
  var symbols = (_symbols = {
    ...
    '=_=': /——/,
    '=$=': /¥/
  }, _symbols["=!="] = /！/, _symbols['="='] = /"“”/, _symbols["='="] = /'‘’/, _symbols['=\\\\\\[='] = /【/, _symbols['=\\\\\\]='] = /】/, _symbols['=\\\\\\(='] = /（/, _symbols['=\\\\\\)='] = /）/, _symbols['=\\\\\\|='] = /｜/, _symbols['=\\\\\\.='] = /。/, _symbols);
  ...
  block.paragraph = edit$1(block._paragraph).replace('blockquote', ' {0,3}>').getRegex();
    ...
    _proto.translate = function translate(src) {
      ...
      while (src) {
        ...
        if (cap = this.rules.link.exec(src)) {
          ...
          dest += cap[0].replace(/！/, '!').replace(/【/, '[').replace(/】/, ']').replace(/（/, '(').replace(/）/, ')').replace(/[“”]/g, '"');
          continue;
        } // code
    ...
    _proto.translate = function translate(src) {
      ...
      while (src) {
        ...
        if (cap = this.rules.blockquote.exec(src)) {
          src = src.substring(cap[0].length);
          this.dest += this.inlineTranslator.translate(cap[0]).replace(/[》〉]/g, '>');
        } // text
